...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'car.count', 'invite.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('car', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('invite', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'invite',
          header: 'Invite',
          accessorKey: 'invite',
          cell: ({ row: { original: record } }: any) => record?._count?.invite,
        }
      : null,
