...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`QA B2C Car sharing`}</title>

        <meta
          name="description"
          content="Unlock Your Journey with QA B2C Car Sharing - Empowering Individuals to Book Cars Nearby and Providing Centralized Management for Operations Staff."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMjByZW50YWx8ZW58MHx8fHwxNjkzMjk4MDc1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock Your Journey with QA B2C Car Sharing - Empowering Individuals to Book Cars Nearby and Providing Centralized Management for Operations Staff.`}
            </Text>
            <Box
